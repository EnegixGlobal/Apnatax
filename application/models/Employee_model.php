...
class Employee_model extends CI_Model{
    ...
    public function addemployeepercent($data){
        ...
        if($status){
            ...
            $update=$this->db->update("emp_percent",['status'=>0,'updated_on'=>$datetime],
        ...
        if($query->num_rows()>0){
            ...
            foreach($purchases as $single){
                ...
                if($getpercent->num_rows()>0){
                    ...
                    $data[]=array('date'=>$date,'emp_id'=>$single['emp_id'],'order_id'=>$single['id'],
                                'order_amount'=>$single['amount'],'percent'=>$percent,'amount'=>$amount,'status'=>0,
