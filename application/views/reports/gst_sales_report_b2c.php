...
<div class="card-body">
    <form method="get" action="<?= base_url('reports/gstsalesreportb2c/'); ?>" class="mb-4">
        <div class="row">
            <div class="col-md-3">
    ...
    <div class="mb-3">
        ...
        $query['export'] = 'csv';
        ?>
        <a href="<?= base_url('reports/gstsalesreportb2c/?' . http_build_query($query)); ?>" class="btn btn-sm btn-outline-primary">Export CSV</a>
        <?php
        $query['export'] = 'json';
        ?>
        <a href="<?= base_url('reports/gstsalesreportb2c/?' . http_build_query($query)); ?>" class="btn btn-sm btn-outline-info">Export JSON</a>
        <?php
        $query['export'] = 'pdf';
        ?>
        <a href="<?= base_url('reports/gstsalesreportb2c/?' . http_build_query($query)); ?>" class="btn btn-sm btn-outline-danger">Export PDF</a>
    </div>

    <div class="table-responsive">
        <table class="table table-bordered table-hover" id="gst_sales_b2c_table">
            <thead>
                <tr>
                    <th>PAN of Recipient</th>
                    <th>Receiver Name</th>
