                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <?php
                                                        $attr=[];
                                                        echo create_form_input('select','month',"Month",true,'',$attr,month_dropdown($this->session->year)); 
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <?php
                                                        $attr=[];
                                                        echo create_form_input('select','month',"Quarter",true,'',$attr,quarter_dropdown($this->session->year)); 
