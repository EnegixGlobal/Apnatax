<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <?= form_open_multipart('employees/updateprofile/'); ?>
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="form-group text-center">
                            ...
                            <div class="mb-3">
                                <?php
                                $user = getuser();
                                $photo_url = !empty($user['photo']) ? file_url($user['photo']) : base_url('profileimage/?letter=' . strtoupper(substr($employee['name'], 0, 1)));
                                ?>
